...
export default function LoginPage() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if ((e.nativeEvent as any).submitter.id === "login" && loginMode) {
      ...
      (e.nativeEvent as any).submitter.id === "register" &&
      loginMode
    ) {
      setLoginMode(false);
    } else if (
  ...
  return (
    ...
    <div className="DashboardLoginDesktop w-full h-[100vh] relative bg-neutral-100">
      <div className="Logo w-[155px] h-[30px] ml-4 sm:ml-4 pt-12 md:ml-12 lg:ml-12">
        <Link href="/" passHref>
          <Image
            src={yuHacks2023Arrow}
            alt="My Image"
            width={152}
            height={27}
          />
      ...
      <div className="MainPage flex flex-col max-w-[950px] max-h[505px] sm:flex-col md:flex-row lg:flex-row justify-center align-center mx-auto my-4 sm:my-4 md:my-16 lg:my-16">
        ...
        <div
          className={`LoginSection w-full  sm:w-full lg:w-1/2 md:w-1/2 flex justify-center items-center ${
            loginMode ? "mb-0" : "mb-48"
          }`}
        >
          <div className="Login   w-[406px] h-[490px]">
            <form onSubmit={handleSubmit}>
              {!loginMode && (
                <div>
                  <div className="Email mt-8 ml-8 text-neutral-400 text-sm font-medium">
                    First Name
                  </div>
                  ...
                  <div className="Email mt-4  ml-8 text-neutral-400 text-sm font-medium">
                    Last Name
                  </div>
                  <div className="Email flex ml-8">
                    <InputField
              ...
              <div className="Password mt-4 ml-8 text-neutral-400 text-sm font-medium">
                Password
              </div>
              ...
              <div className="Frame162 w-[346px] h-[70px] ml-8 py-6 justify-center items-center gap-2.5 inline-flex">
                ...
                <div className="OrLogInUsing text-center text-neutral-400 text-base font-medium">
                  Or log in using
                </div>
