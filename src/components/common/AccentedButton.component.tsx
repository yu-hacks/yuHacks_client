...
// example
{/* <PrimaryButton name='sec. Direction Button' buttonType='action' primary={true} fullWidth={true}/> */}
         ...
         if(fullWidth){
          if(primary){
            if(buttonType === 'default'){
              return (
                <div className={full}>
                  <button className={fullPrimary}>{name}</button> 
                </div>
              )
             }else if(buttonType === 'direction'){
              return (
                <div className={full}>
                  <button className={fullPrimary}>{name}&ensp;<FaChevronRight className='h-6 w-6 py-1'/></button> 
                </div>
              );
             }else if(buttonType === 'action'){
              return (
                <div className={full}>
                  <button className={fullPrimary}><MdDownload className='h-7 w-7 py-[2px]'/>&ensp;{name}</button> 
                </div>
              );
             }
          }else{
            if(buttonType === 'default'){
              return (
                <div className={full}>
                  <button className={fullSecondary}>{name}</button> 
                </div>
              )
             }else if(buttonType === 'direction'){
              return (
                <div className={full}>
                  <button className={fullSecondary}>{name}&ensp;<FaChevronRight className='h-6 w-6 py-1'/></button> 
                </div>
              );
             }else if(buttonType === 'action'){
              return (
                <div className={full}>
                  <button className={fullSecondary}><MdDownload className='h-7 w-7 py-[2px]'/>&ensp;{name}</button> 
                </div>
              );
             }
          }
          ...
          if(primary){
            if(buttonType === 'default'){
              return (
                <button className={normalPrimary}>{name}</button> 
              )
             }else if(buttonType === 'direction'){
              return (
                <button className={normalPrimary}>{name}&ensp;<FaChevronRight className='h-6 w-6 py-1'/></button> 
              );
             }else if(buttonType === 'action'){
              return (
                <button className={normalPrimary}><MdDownload className='h-7 w-7 py-[2px]'/>&ensp;{name}</button> 
              );
             }
          }else{
            if(buttonType === 'default'){
              return (
                <button className={normalSecondary}>{name}</button> 
              )
             }else if(buttonType === 'direction'){
              return (
                <button className={normalSecondary}>{name}&ensp;<FaChevronRight className='h-6 w-6 py-1'/></button> 
              );
             }else if(buttonType === 'action'){
              return (
                <button className={normalSecondary}><MdDownload className='h-7 w-7 py-[2px]'/>&ensp;{name}</button> 
              );
             }
          }
         }
