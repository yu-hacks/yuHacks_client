  ...
  return (
    ...
    >
      ...
      >
        <div
          id="sponsor-media"
          className="flex justify-center align-middle shrink-0 md:mt-0 md:basis-1/3"
        >
          <div>
        ...
        <div id="sponsor-text" className="mx-8 my-12 lg:m-16 lg:pl-8">
          ...
          <h3 className="font-semibold text-4xl text-[#F8E1BF] drop-shadow-[0_2px_12px_rgba(231,156,43,0.3)]  mb-10 max-w-[500px]">
            Sponsor, Support,{" "}
            <span className="text-[#F1C480]">Supercharge</span> a New
            Possibility
          </h3>
          <p className="text-lg text-[#C3C3C3] max-w-[500px]">
            We work with some of the best organizations in the industry, they
            are what make the whole experience possible. Be a part of something
            that brings you positive surprises by supporting the next generation
            of hackers.
          </p>
